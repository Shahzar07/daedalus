...
This skill is designed for the Daedalus agent. It uses Daedalus tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Daedalus skills for specific phases:
